...
Function V_LogScalePrefCheck(string ctrlName, variable checked) : CheckBoxControl
...
Function V_UnityTransPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gDoTransCheck
	gVal = checked
End

Function V_XMLWritePref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gXML_Write
	gVal = checked
End

Function V_NXCanSASWritePref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gNXcanSAS_Write
	gVal = checked
End

Function V_WritePref(string ctrlName, variable checked) : CheckBoxControl
...
Function V_DoTransCorrPref(string ctrlName, variable checked) : CheckBoxControl
...
Function V_DoEfficiencyCorrPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gDoTubeShadowCor
	gVal = checked
End

Function V_DoRawAttenAdjPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gDoAdjustRAW_Atten
	gVal = checked
End

Function V_DoDIVCorPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gDoDIVCor
	gVal = checked
End

Function V_DoDeadTimeCorPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gDoDeadTimeCor
	gVal = checked
End

Function V_DoSolidAngleCorPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gDoSolidAngleCor
	gVal = checked
End

Function V_DoNonLinearCorPref(string ctrlName, variable checked) : CheckBoxControl
...
Function V_DoMonitorNormPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gDoMonitorNormalization
	gVal = checked
End

Function V_DoDownstreamWindowCorPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gDoDownstreamWindowCor
	gVal = checked
End

Function V_IgnoreDetBPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:VSANS:Globals:gIgnoreDetB
	gVal = checked
End

Function V_LaptopModePref(string ctrlName, variable checked) : CheckBoxControl
...
Function V_PrefDoneButtonProc(string ctrlName) : ButtonControl
...
//
Function V_PrefTabProc(string name, variable tab)
