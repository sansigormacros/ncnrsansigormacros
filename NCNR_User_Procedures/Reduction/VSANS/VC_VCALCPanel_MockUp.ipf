...
Function V_VCALCHelpButtonProc(string ctrlName) : ButtonControl
...
Function V_VCALCShowMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
// VCALC#Panels_IQ
Function VC_RemoveOffset_ButtonProc(string ctrlName) : ButtonControl
...
Function VC_AllQ_Plot_1D_ButtonProc(string ctrlName) : ButtonControl
...
Function V_VCALCSaveConfiguration(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_VCALCSaveNICEConfiguration(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_VCALCRecalcButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function VC_Recalculate_AllDetectors()
	...
	// plot the results (1D)
	string type = "VCALC"
	string str, workTypeStr
	string winStr = "VCALC#Panels_IQ"
...
//
//
Function VCALCTabProc(string name, variable tab)
...
Function V_GuideSliderProc(string ctrlName, variable sliderValue, variable event)
...
Function Front2DQ_Log_CheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
Function VC_SourceAperDiamSelectPopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function VC_SampleAperDiamSelectPopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function VC_SourceApShapeSelectPopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function VC_SampleApShapeSelectPopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function VC_DeltaLamSelectPopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
//
// then recalculate
Function VC_MonochromSelectPopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
//
Function VC_PresetConfigPopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
//
Function VC_SimModelFunc_PopProc(string ctrlName, variable popNum, string popStr) : PopupMenuControl
...
//
Function VC_RebinIQ_PopProc(string ctrlName, variable popNum, string popStr) : PopupMenuControl
...
Function V_QMin_withBeamStop(string detStr)
...
Function V_BeamDiamDisplay(string direction, string detStr)
...
Function V_BeamStopDiamDisplay(string detStr)
