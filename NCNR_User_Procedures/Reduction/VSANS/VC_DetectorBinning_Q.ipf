...
//
Function ClearIQIfDisplayed_AllFldr(string type, string winNameStr)
...
// VCALC panel can pass in "" for the winNameStr
//
Function ClearIQIfDisplayed_AllBin(string fldr, string winNameStr)
...
Function ClearIQIfDisplayed(string fldr, string type, string winNameStr)
