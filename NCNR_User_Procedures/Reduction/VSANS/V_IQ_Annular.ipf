...
//
// width defined in +/- in A^-1
Function V_QBinAllPanels_Annular(string folderStr, string detGroup, variable qCtr_Ann, variable qWidth)
...
Function V_Phi_Graph_Proc(string folderStr, string detGroup)
...
//
//
Function V_fDoAnnularBin_QxQy2D_New(string folderStr, string type, variable qCtr_Ann, variable qWidth)
...
//
//
Function V_fWrite1DAnnular_new(string pathStr, string folderStr, string detGroup, string saveName)
...
Function V_MarkAnnularOverlayPixels(WAVE qTotal, WAVE overlay, variable qCtr_ann, variable qWidth)
