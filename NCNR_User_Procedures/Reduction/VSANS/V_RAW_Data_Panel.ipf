...
//
Function V_UpdateDisplayInformation(string type)
...
//
//
Function VSANSDataHook(STRUCT WMWinHookStruct &s)
...
//
//
Function V_DataTabProc(STRUCT WMTabControlAction &tca) : TabControl
...
Function V_FakeTabClick(variable tab)
...
//
Function V_File_minus_ButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_File_plus_ButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_Tab_p_ButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_SensorButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_AvgMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_IsolateButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_ToWorkFileButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
//
Function V_IvsQPanelButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_annularAvgButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_StatusButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_LogLinButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_TagFileButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
// -- any other options?
Function V_SaveIQ_ButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_BeamCtrButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_SpreadPanelButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_RestorePanelButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_HiMapSliderProc(STRUCT WMSliderAction &sa) : SliderControl
...
// -- see Buttons.ipf for the old SANS implementation
//
Function V_LowMapSliderProc(STRUCT WMSliderAction &sa) : SliderControl
