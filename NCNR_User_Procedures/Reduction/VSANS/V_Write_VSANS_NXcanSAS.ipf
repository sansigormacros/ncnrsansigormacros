...
Function V_WriteNXcanSAS1DData(string pathStr, string folderStr, string saveName)
...
Function V_WriteMetaData(variable fileID, string base, string parentBase, string folderStr, WAVE/T proto)
