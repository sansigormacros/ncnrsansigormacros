...
Function V_DeadTimeCorrectionTubes(WAVE dataW, WAVE data_errW, WAVE dtW, variable ctTime)
...
//
//
Function V_ConvertBeamCtrPix_to_mm(string folder, string detStr, string destPath)
...
//
Function V_ConvertBeamCtr_to_pix(string folder, string detStr, string destPath)
...
// the value in pixels is written to the local data folder, NOT to disk (it is recalculated as needed)
//
Function V_ConvertBeamCtr_to_pixB(string folder, string detStr, string destPath)
...
//
//
Function V_ConvertBeamCtrPix_to_mmB(string folder, string detStr, string destPath)
...
//
Function V_TubePixel_to_mm(variable c0, variable c1, variable c2, variable pix)
...
//
Function V_Detector_CalcQVals(string fname, string detStr, string destPath)
...
//
threadsafe Function V_CalcQval(variable xaxval, variable yaxval, variable xctr, variable yctr, variable sdd, variable lam, WAVE distX, WAVE distY)
...
//
threadsafe Function V_CalcQX(variable xaxval, variable yaxval, variable xctr, variable yctr, variable sdd, variable lam, WAVE distX, WAVE distY)
...
// this properly accounts for qz
//
threadsafe Function V_CalcQY(variable xaxval, variable yaxval, variable xctr, variable yctr, variable sdd, variable lam, WAVE distX, WAVE distY)
...
//
threadsafe Function V_CalcQZ(variable xaxval, variable yaxval, variable xctr, variable yctr, variable sdd, variable lam, WAVE distX, WAVE distY)
...
//
Function V_SolidAngleCorrection_COS3(WAVE w, WAVE w_err, string fname, string detStr, string destPath)
...
//
Function V_LargeAngleTransmissionCorr(WAVE w, WAVE w_err, string fname, string detStr, string destPath)
...
Function V_Absolute_Scale(string type, string absStr)
...
//
//
Function V_Adjust_RAW_Attenuation(string type)
...
//
Function V_DIVCorrection(WAVE data, WAVE data_err, string detStr, string workType)
...
Function V_SubtractReadNoiseBack(string folder, variable readNoise)
...
//
Function V_TubeEfficiencyShadowCorr(WAVE w, WAVE w_err, string fname, string detStr, string destPath)
...
Function V_Efficiency_Integral(WAVE pWave, variable in_u)
...
//
Function V_TubeShadowEfficTableOneLam(variable lambda)
...
//
//
Function V_WindowTransmission(variable tw)
...
//
//
Function V_DownstreamWindowTransmission(WAVE w, WAVE w_err, string fname, string detStr, string destPath)
