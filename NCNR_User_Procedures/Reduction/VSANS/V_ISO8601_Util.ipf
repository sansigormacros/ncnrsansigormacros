...
Function/S V_CurrentTime_to_ISO8601String(variable now)
...
//
Function V_ISO8601_to_IgorTime(string ISOstr)
...
//
//
Function V_Compare_ISO_Dates(string iso1, string iso2)
