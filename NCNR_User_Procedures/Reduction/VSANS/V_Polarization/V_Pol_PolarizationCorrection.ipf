...
Function V_RestorePolCorPanel()
	...
	WAVE/Z/T w = root:Packages:NIST:VSANS:Globals:Polarization:PolCor_popState
...
Function V_ManualRunEntry(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_SavePolCorPanelButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_RestorePolCorPanelButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_PolCor_FileListBoxProc(STRUCT WMListboxAction &lba) : ListBoxControl
...
//
Function V_PolCorPanelHook(STRUCT WMWinHookStruct &s)
...
// val = 1 to disable
// val = 0 to show
Function V_ToggleSelControls(string str, variable val)
...
Function V_PolCorTabProc(STRUCT WMTabControlAction &tca) : TabControl
...
// 0 = SAM, 1 = EMP, 2 = BGD
Function V_ChangeDataTab(variable tab)
...
Function V_PolCorHelpParButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_LoadRawPolarizedButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_LoadPolarizedData(string pType)
...
//
Function V_AddToPolMatrix(WAVE matA, WAVE matA_err, string pType, variable tMid)
...
//
Function V_MakePCResultWaves(string type, string pType)
...
//
//
Function V_TagLoadedData(string type, string pType)
...
//
Function V_PolCorButton(STRUCT WMButtonAction &ba) : ButtonControl
...
// - crude right now
//
Function V_Display4XSButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_ChangeDisplayedPolData(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_ShowPolMatrixButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_getTimeMidpoint(string listStr)
...
//
//
Function V_ReducePolCorDataButton(string ctrlName) : ButtonControl
...
//
Function V_ExecutePolarizedProtocol(string protStr, string pType)
...
//
Function V_SavePolCorProtocolButton(string ctrlName) : ButtonControl
...
//
Function V_MakePolProtocolFromPanel(WAVE/T w)
...
//
Function V_Display_4(string type, string scaling)
...
Function V_X4_Log_CheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
Function V_Change4xsButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_FillXSPanels(string type, string polType)
...
Function V_getQxQyScaling(WAVE dataW, string detStr, variable &minQx, variable &maxQx, variable &minQy, variable &maxQy)
...
//
Function V_PolPanels_AsQ(string type, string polType, string carr)
...
Function V_2DQ_Range_SetVarProc(STRUCT WMSetVariableAction &sva) : SetVariableControl
...
//
Function V_ClearPolCorEntries(STRUCT WMButtonAction &ba) : ButtonControl
