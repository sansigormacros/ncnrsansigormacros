...
Function V_SaveFlipperPanelButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_RestoreFlipperPanelButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_AddFlipperConditionButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_FlipperPanelPopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function V_MakeFlipperResultWaves(string popStr)
...
//
Function V_ManualEnterPfPsmButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_FlipperAverageButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_Calc_PsmPf(WAVE w, WAVE calc, string gCellKW, variable selRow, variable &err_PsmPf)
...
//
//
Function V_Calc_Psm(WAVE w, WAVE calc, string gCellKW, variable selRow, variable &err_Psm)
...
//
Function V_Calc_PHe_atT(variable Po, variable err_Po, variable gam, variable err_gam, variable t2, variable &err_Pt)
...
//
Function V_Calc_PCell_atT(variable muPo, variable err_muPo, variable gam, variable err_gam, variable t2, variable &err_PCell)
...
Function V_ShowFlipperCalcButton(STRUCT WMButtonAction &ba) : ButtonControl
...
// clear just the row
//
Function V_ClearFlipperRowButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
//
Function V_ClearAllFlipperWavesButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_FlipperHelpParButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_ParseFlipperRow(WAVE w, variable selRow)
...
//
Function V_Write1DWaveToITX(WAVE w, variable refnum)
...
// the file is NOT closed when exiting
//
Function V_Write1DTextWaveToITX(WAVE/T w, variable refnum)
...
// the file is NOT closed when exiting
//
Function V_Write2DTextWaveToITX(WAVE/T w, variable refnum)
...
// the file is NOT closed when exiting
//
Function V_Write2DWaveToITX(WAVE w, variable refnum)
...
//
//
Function V_FlipperTableHook(string infoStr)
