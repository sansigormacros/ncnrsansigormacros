...
Function V_Update1D_Graph(string workType, variable binType)

	//
	// x- "B" detector is currently skipped - Q is not yet calculated
	string str, workPathStr
	string winStr = "V_1D_Data"
...
Function V_Plot1D_LogCheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
Function V_RemoveOffset_ButtonProc(string ctrlName) : ButtonControl
...
Function V_AllQ_Plot_1D_ButtonProc(string ctrlName) : ButtonControl
...
//
Function V_BinningModePopup(string ctrlName, variable popNum, string popStr) : PopupMenuControl
