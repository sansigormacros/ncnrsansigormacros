...
Function V_DIVSetupButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_DIVClearOldButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_DIVNormalizeButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_DIVCopyButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_DIVMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_DIVSaveButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function Vf_DIVCopy_proc(string reducedFolderType, string carriageStr, variable first)
...
//
Function Vf_NormalizeDIV_proc(string carriageStr)
...
//
Function V_NormalizeDIV_allEight(string type)
...
//    what is done in SANS)
//
Function V_NormalizeDIV_oneCarriage(string type, string carriageStr)
...
//    what is done in SANS)
//
Function V_NormalizeDIV_onePanel(string type, string detStr)
...
//
Function V_CopyDIVToSave_OnePanel(string type, string detStr)
...
Function V_DispFolderPopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function V_DispCarriagePopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function V_DispOperationPopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function V_DispUpdateButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
