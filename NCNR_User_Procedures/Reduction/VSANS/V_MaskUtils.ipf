...
Function V_DrawMaskHelpButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_DrawMaskRadioCheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
Function V_MaskWindowHook(STRUCT WMWinHookStruct &s)
...
//
Function V_ToggleMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_AddToMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_AddShapeToMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_MaskToolsButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_RemoveFromMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_SetMaskPanelPopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function V_DrawPanelToMask(string str)
...
// and is not checked
//
Function V_OverlayMask(string str, variable state)
...
Function V_SaveMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_PickFolderPopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function V_PickCarriagePopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function V_UpdatePanelsButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_ToggleFourMaskButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_ShowAvgRangeButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function V_DoPanelAvgButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function V_AvgPanelHelpButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
//
Function V_OverlayFourMask(string folderStr, string detStr, variable state)
...
//
//
Function V_OverlayFourAvgMask(string folderStr, string detStr, variable state)
