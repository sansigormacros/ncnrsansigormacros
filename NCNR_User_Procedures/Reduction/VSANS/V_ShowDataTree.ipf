...
// Pass level = 0 to start
Function V_ListDataFolder(DFREF dfr, variable level, string sNBName)
...
Function V_WriteBrowserInfo(string sString, variable vType, string sNBName)
...
Function/S V_PrintWaveType(WAVE w)
