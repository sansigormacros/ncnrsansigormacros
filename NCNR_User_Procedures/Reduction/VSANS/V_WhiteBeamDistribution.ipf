...
Function V_WhiteBeamDist_top(variable lam)
...
Function V_WhiteBeamDist_mid_noNorm(variable lam)
...
// 3 -> 9 == 1
//
Function V_WhiteBeamDist_mid(variable lam)
...
Function V_WhiteBeamInterp(variable lam)
...
// this is not commonly used - there is no improvement in the results when using the "full" shape of the
// WB distribution.
Function V_WhiteBeamInterp_noNorm(variable lam)
...
//
//
Function V_SuperWhiteBeamDist_mid_noNorm(variable lam)
...
//
Function V_SuperWhiteBeamDist_mid(variable lam)
