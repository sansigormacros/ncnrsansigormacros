...
Proc CatVShort_SortButtonProc(ctrlName) : ButtonControl
	String ctrlName
...
Proc RealTime_MainButtonProc(ctrlName) : ButtonControl
	...
	if (exists("QUOKKA") != 0)
		ShowOnlineReductionPanel()
	else // elseif is not allowed in Macros
...
//on tab(0) - Raw Data - initially visible
	...
	Button MainButton_0b,pos={15,120},size={130,20},proc=PatchMainButtonProc,title="Patch"
	Button MainButton_0b,help={"Patch will update incorrect information in raw data headers"}
	Button MainButton_0c,pos={15,150},size={130,20},proc=TransMainButtonProc,title="Transmission"
	...
	Button MainButton_0d,pos={15,180},size={130,20},proc=RealTime_MainButtonProc,title="Online Reduction"
