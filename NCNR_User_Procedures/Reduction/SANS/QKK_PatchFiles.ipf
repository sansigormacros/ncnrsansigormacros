...
//				Print "found ", item,ii
	...
	if(gRadioVal == 3)
		...
		if(pos == -1)		//no wildcard
			...
			// [davidm] preperations for string comparison
			if (strsearch(match, ".", 0) == -1)
				match = match[0,pos-1] + "." + match[pos,inf];
				pos = pos + 1;
			endif
			String compareStr
			if (strlen(match) == pos+1)
				compareStr = match[0,pos-1];
			else
				compareStr = match;
			endif
		endif
		...
		for(ii=0;ii<num;ii+=1)
			...
			// [davidm] string comparison
			elseif(strsearch(num2str(sdd), compareStr, 0) != -1)
					list += item + ";"
			endif
		endfor
...
Function GetCheckBoxesState(w,num)
	...
	Endif
//	[davidm] label cannot be patched
...
//	[davidm] label cannot be patched
//	CheckBox checkPS1,pos={18,108},size={20,20},title="",disable=2
//	CheckBox checkPS1,help={"If checked, the entered value will be written to the data file if either of the \"Change..\" buttons is pressed."},value=0
	CheckBox checkPV1,pos={18,126+4},size={20,20},title=""
	...
	CheckBox checkPV2,pos={18,144+4},size={20,20},title=""
	...
	CheckBox checkPV3,pos={18,162+4},size={20,20},title=""
	...
	CheckBox checkPV4,pos={18,180+4},size={20,20},title=""
	...
	CheckBox checkPV5,pos={18,198+4},size={20,20},title=""
	...
	CheckBox checkPV6,pos={18,216+4},size={20,20},title=""
	...
	CheckBox checkPV7,pos={18,234+4},size={20,20},title="",value=0
	...
	CheckBox checkPV8,pos={18,252+4},size={20,20},title="",value=0
	...
	CheckBox checkPV9,pos={18,270+4},size={20,20},title="",value=0
	...
	CheckBox checkPV10,pos={18,288+4},size={20,20},title="",value=0
	...
	CheckBox checkPV11,pos={18,306+4},size={20,20},title="",value=0
	...
	CheckBox checkPV12,pos={18,324+4},size={20,20},title="",value=0
	...
	CheckBox checkPV13,pos={18,342+4},size={20,20},title="",value=0
	...
	CheckBox checkPV14,pos={18,360+4},size={20,20},title="",value=0
	...
	CheckBox checkPV15,pos={18,378+4},size={20,20},title="",value=0
	...
	CheckBox checkPV16,pos={18,396+4},size={20,20},title="",value=0
	...
	CheckBox checkPV17,pos={18,414+4},size={20,20},title="",value=0
	...
	CheckBox checkPV18,pos={18,432+4},size={20,20},title="",value=0
	...
	CheckBox checkPV19,pos={18,450+4},size={20,20},title="",value=0
