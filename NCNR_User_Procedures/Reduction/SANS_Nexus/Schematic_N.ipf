...
//with returns
//
Function/S StackText(string inStr)
...
//
Function SetGraphic(string type, string choice)
...
//
Function/S getTransStrFromReals(string type)
...
//currently in the "type" folder (not from the binary header)
//
Function/S getThickStrFromReals(string type)
...
//currently in the "type" folder (not from the binary header)
//
Function/S GetAttenNumStrFromReals(string type)
