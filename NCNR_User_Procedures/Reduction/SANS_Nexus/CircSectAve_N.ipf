...
Function CircularAverageTo1D_old(string type)
	...
	//BEGIN AVERAGE **********
	variable xi, dxi, dx, jj, data_pixel, yj, dyj, dy
	variable mask_val = 0.1
...
//
Function IncrementPixel(variable dataPixel, variable ddr, variable dxx, variable dyy, WAVE aveint, WAVE dsq, WAVE ncells, variable nq, variable nd2)
...
//
Function dphi_pixel(variable dxx, variable dyy, variable phi_x, variable phi_y)
...
//
Function FX(variable xx, variable sx3, variable xcenter, variable sx)
...
//
Function FY(variable yy, variable sy3, variable ycenter, variable sy)
...
Function Ave_button(string button0) : ButtonControl
...
//
//
Function Sector_PlusMinus1D(string type)
...
Function CircularAverageTo1D(string type)
...
//
Function SetDeltaQ(string folderStr)
...
//
Function SectorAverageTo1D(string folderStr)
...
// dphi_rad = half-width of sector, also in radians
//
Function fDoSectorBin_QxQy2D(string folderStr, string side, variable phi_rad, variable dphi_rad)
...
Function/WAVE MakePhiMatrix(WAVE qTotal, string folderStr, string folderPath)
...
//
Function MarkSectorOverlayPixels(WAVE phi, WAVE overlay, variable phiCtr, variable delta, string side)
