...
Function LoadTISANELog_Proc(string ctrlName) : ButtonControl
...
Function TISANEDone_Proc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function ProcessLog_Proc(string ctrlName) : ButtonControl
...
Function sliceSelect_Proc(string ctrlName, variable varNum, string varStr, string varName) : SetVariableControl
...
Function ProcessLog(variable nslices, variable slicewidth)
...
Function FindBin(variable nticks, variable nslices)
