...
//
// set True to use Igor's own draw method rather than native
Function CleanupData_w_Progress(variable indefinite, variable useIgorDraw)
...
//
Function/S getFileIntentPurposeList(string intent, string purpose, variable method)
