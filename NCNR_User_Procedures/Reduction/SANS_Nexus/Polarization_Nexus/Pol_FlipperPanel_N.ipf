...
Function SaveFlipperPanelButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function RestoreFlipperPanelButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AddFlipperConditionButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function FlipperPanelPopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function MakeFlipperResultWaves(string popStr)
...
//
Function ManualEnterPfPsmButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function FlipperAverageButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Calc_PsmPf(WAVE w, WAVE calc, string gCellKW, variable selRow, variable &err_PsmPf)
...
//
//
Function Calc_Psm(WAVE w, WAVE calc, string gCellKW, variable selRow, variable &err_Psm)
...
//
Function Calc_PHe_atT(variable Po, variable err_Po, variable gam, variable err_gam, variable t2, variable &err_Pt)
...
//
Function Calc_PCell_atT(variable muPo, variable err_muPo, variable gam, variable err_gam, variable t2, variable &err_PCell)
...
Function ShowFlipperCalcButton(STRUCT WMButtonAction &ba) : ButtonControl
...
// clear just the row
//
Function ClearFlipperRowButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
//
Function ClearAllFlipperWavesButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function FlipperHelpParButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function ParseFlipperRow(WAVE w, variable selRow)
...
//
Function Write1DWaveToITX(WAVE w, variable refnum)
...
// the file is NOT closed when exiting
//
Function Write1DTextWaveToITX(WAVE/T w, variable refnum)
...
// the file is NOT closed when exiting
//
Function Write2DTextWaveToITX(WAVE/T w, variable refnum)
...
// the file is NOT closed when exiting
//
Function Write2DWaveToITX(WAVE w, variable refnum)
