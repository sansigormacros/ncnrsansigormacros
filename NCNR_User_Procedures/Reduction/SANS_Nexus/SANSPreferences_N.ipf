...
Function LogScalePrefCheck(string ctrlName, variable checked) : CheckBoxControl
...
Function DRKProtocolPref(string ctrlName, variable checked) : CheckBoxControl
...
Function UnityTransPref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:myGlobals:gDoTransCheck
	gVal = checked
End

Function XMLWritePref(string ctrlName, variable checked) : CheckBoxControl

	NVAR gVal = root:Packages:NIST:gXML_Write
	gVal = checked
End

Function PrefDoneButtonProc(string ctrlName) : ButtonControl
