...
//
Function Correct(variable mode)
...
Function CorrectMode_11()
	...
	variable lambda, attenNo, sam_AttenFactor, bgd_attenFactor, emp_AttenFactor
	variable tmonsam, fsam, fbgd, xshift, yshift, rsam, csam, rbgd, cbgd, tmonbgd
	variable tsam, temp, remp, cemp, tmonemp, femp, time_sam, time_drk, savmon_sam
	variable wcen = 0.001
...
Function CorrectMode_12()
	...
	variable lambda, attenNo, sam_AttenFactor, bgd_attenFactor
	variable tmonsam, fsam, fbgd, xshift, yshift, rsam, csam, rbgd, cbgd, tmonbgd
	variable time_drk, time_sam, savmon_sam, tsam
	variable wcen = 0.001
	variable sam_atten_err, bgd_atten_err
	fileStr         = getFileNameFromFolder("SAM")
	sam_AttenFactor = getAttenuator_transmission(fileStr)
...
Function CorrectMode_13()
	...
	variable lambda, attenNo, sam_AttenFactor, emp_attenFactor
	variable tmonsam, fsam, femp, xshift, yshift, rsam, csam, remp, cemp, tmonemp
	variable tsam, temp, savmon_sam, time_sam, time_drk
	variable wcen = 0.001
	variable sam_atten_err, emp_atten_err
...
//
Function GetShiftedArray(WAVE data_in, WAVE data_out, WAVE noadd_mat, variable xshift, variable yshift)
...
//
Function WorkDataExists(string type)
...
//
Function GetNewTrans(variable oldTrans, string type)
...
Function IgnoreNowButton(string ctrlName) : ButtonControl
...
Function DoTransInput(string str)
...
Function IgnoreAlwaysButtonProc(string ctrlName) : ButtonControl
...
Function UseNewValueButtonProc(string ctrlName) : ButtonControl
...
Function AbortCorrectionButtonProc(string ctrlName) : ButtonControl
