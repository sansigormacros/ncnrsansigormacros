...
//
Function LoadRawSANSData(string file, string folder)
...
//
//
Function ReadHeaderAndData(string fname, string folderStr)
...
Function MakeDataWaves_DP(string fname)
...
//
//
Function getRealValueFromHDF5(string fname, string path)
...
//
Function/WAVE getRealWaveFromHDF5(string fname, string path)
...
// if the wave is null, then that is returned, and the calling function is responsible
//
Function/WAVE getTextWaveFromHDF5(string fname, string path)
...
Function getIntegerFromHDF5(string fname, string path)
...
//
Function/S getStringFromHDF5(string fname, string path, variable num)
...
//
// see AG's function OverWriteFilePurpose() in VSANS code
//
//
// (DONE):
...
//
Function WriteWaveToHDF(string fname, string groupName, string varName, WAVE wav)
...
// -x change the /P=home to the user-defined data path (catPathName)
//
Function WriteTextWaveToHDF(string fname, string groupName, string varName, WAVE/T wav)
...
// -x change the /P=home to the user-defined data path (catPathName)
//
Function WriteWaveToHDF_old(string fname, string groupName, string varName, WAVE wav)
...
// -x change the /P=home to the user-defined data path (catPathName)
//
Function WriteTextWaveToHDF_old(string fname, string groupName, string varName, WAVE/T wav)
...
Function HDF_NXSANS_SaveGroupAsHDF5(string dfPath, string filename)
