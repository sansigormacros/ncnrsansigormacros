...
//
//
Function FindConfigurationFiles(variable row)
...
Function/S FindFileContainingString(string matchStr)
...
Function SameSDD_byRun(variable runNum, variable sdd)
...
//
Function SameSDD_byName(string fname, variable sdd)
...
Function SameWavelength_byRun(variable runNum, variable lambda)
...
// -- fuzzy test, within 1% is a match
//
Function SameWavelength_byName(string fname, variable lambda)
...
//
Function FillInProtocol(variable index)
...
Function Auto_SaveProtocol(variable index)
...
//
Function/S Auto_CalcKappa(variable runNum)
...
//
Function Auto_FindWriteBeamCenter(variable runNum)
...
//
Function Auto_SetXYBox(variable runNum)
...
//
Function RemoveWrongLamFromSDDList(variable testLam)
...
//
//
Function Auto_NSORT(variable tableOnly)
...
//
Function Auto_Write1DData(string folderStr, string delim, string term)
...
//
Function Auto_Concatenate(string folder1, string folder2)
...
Function Auto_Sort(string folderStr)
...
//
Function Auto_TrimData(string folderStr, variable nEnd)
...
//
Function/S GetPrefixAndNumStrFromFile(string item)
...
//
Function AutoReduceHelpButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function AutoAskForConfigButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AutoSortConfigButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AutoFillProtocolButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AutoCalcTransButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AutoFindUnityTransButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AutoFindLargeTransButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AutoReduceEverythingButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AutoNSORTTableButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function AutoNSORTEverythingButton(STRUCT WMButtonAction &ba) : ButtonControl
