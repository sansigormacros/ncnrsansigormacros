...
Function NormalizeDIV(string type)
...
Function MakeDIVFile(string ctrType, string offType)
...
//
//
Function CopyDIVToSave_OnePanel(string type)
...
Function ReplaceDataBlock(string ctrType, string offType, variable x1, variable x2, variable y1, variable y2)
...
//
Function XYContinueButtonProc(string ctrlName)
...
//
Function GetXYRange(variable &x1, variable &x2, variable &y1, variable &y2)
...
//
Function ShowBoxButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
// do everything...
//
Function GenerateDIVButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
// done
//
Function DoneDIVButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function ReloadDIVButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function DIVHelpButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function CompareDIVButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function CheckDIVBeamCenter(string str, variable xc, variable yc)

	variable err, ii, num, tmpX, tmpY, badCtr
	variable tol = 10
