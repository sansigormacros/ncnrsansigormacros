...
Function SumCountsInBox(variable x1, variable x2, variable y1, variable y2, variable &ct_err, string type)
...
//
Function DoBoxSum(string fileStr, variable x1, variable x2, variable y1, variable y2, string type)
...
Function DoBoxGraph(WAVE FileID, WAVE BoxCounts, WAVE BoxCount_err)
...
Function BoxSum() : GraphMarquee
	...
	string fileStr = ""
	string msgStr  = "Enter a comma-delimited list of run numbers, use dashes for ranges"
	string type    = "RAW"
...
Function KeepSelectionInBounds(variable &x1, variable &x2, variable &y1, variable &y2)
...
Function testKeepInBounds(variable x1, variable x2, variable y1, variable y2)
...
//
Function DoHistogramPair(variable xin, variable yin)
...
Function SH_FreeCursorCheck(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
Function SH_RecalcButton(STRUCT WMButtonAction &ba) : ButtonControl
...
Function SH_DoneButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function DoAnnulusSum(string fileStr, variable qCtr, variable delta, string type)
...
//
Function SumCountsInAnnulus(variable qCtr, variable delta, variable &ct_err, string type)

	variable ii, jj, err2_sum, testQ
	variable counts = 0
...
Function DoAnnulusGraph(WAVE FileID, WAVE AnnulusCounts, WAVE AnnulusCount_err)
...
//
Function DoArcSum(string fileStr, variable qCtr, variable delta, string type, string sideStr, variable phi, variable deltaPhi)
...
//sums the data counts in the annulus specified by qCtr and delta (units of Q, not pixels)
//
Function SumCountsInArc(variable qCtr, variable delta, variable &ct_err, string type, string sideStr, variable phi, variable deltaPhi)

	variable ii, jj, err2_sum, testQ, testPhi
	variable counts = 0
...
//
Function phiTestArcSum(variable testPhi, variable phi, variable dPhi, string side)
...
Function DoArcGraph(WAVE FileID, WAVE ArcCounts, WAVE ArcCount_err)
