...
// 2025-- this file is tha main include file for all Nexus-based SANS reduction.
// each particular instrument has a small includ file that sets the menu and ksDetType string
// then incudes this file that has all of the functionality, switching as needed based on the
// detector type
