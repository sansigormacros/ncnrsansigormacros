...
//
Function GetTransHeaderInfoToWave(string fname, string sname)
...
//
Function PickEMPTransButton(string ctrlName) : ButtonControl
...
//
Function AssignSelTransFilesToData(variable startRow, variable endRow)
...
//
Function AssignTotalTransFilesToData(variable startRow, variable endRow)
...
//
Function fClearSelectedAssignments(variable startRow, variable endRow, variable target)
...
// 3/31/04  SRK
//
Function CalcSelTransFromHeader(variable startRow, variable endRow)
	...
	string pathName, textStr, abortStr, emptyFile, transFile, samFileStr, empFileStr
	string suffix = ""
...
//
Function CalcTotalTrans(variable startRow, variable endRow)
...
// updated: 5/11/2006 by Bryan Greenwald
//
Function CalcWholeTrans(variable startRow, variable endRow)
...
Function TotalTransButtonProc(string ctrlName) : ButtonControl
...
//
Function Trn_PickPathButton(string PathButton) : ButtonControl
...
//
Function Trn_SetXYBoxButton(string ctrlName) : ButtonControl
...
//
Function Trn_CalcAllFilesButton(string ctrlName) : ButtonControl
...
//
Function Trn_CalcSelectedFilesButton(string ctrlName) : ButtonControl
...
//
Function TotalTrans(string ctrlName) : ButtonControl
...
//
Function Trn_PanelDoneButtonProc(string ctrlName) : ButtonControl
...
Function ChangeBSXPos(string fname, variable xpos)
...
Function UnConvertButtonProc(string ctrlName) : ButtonControl
...
//
Function ConvertButtonProc(string ctrlName) : ButtonControl
...
//
Function FillEMPFilenameWSelection(string ctrlName)
...
//
//number of characers to use from the beginning of the label, and the row of the sample file
Function GuessTransFile(variable charsToUse, variable row)
...
//
//number of characers to use from the beginning of the label, and the row of the transmission file
//rows where (potential) matches found. initially zero points
Function GuessTransToScattFiles(variable charsToUse, variable row, WAVE matchRows)
	...
	variable num, ii, found
	variable tolerance = 0.01 //0.01 = 1% tolerance
	string   transStr  = ""
	string   testStr   = ""
...
//
Function fGuessTransToScattFiles(variable numChars)
...
Function GuessFromTableHook(string infoStr)
...
Function DoAssignTransButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function DoTryAgainMoreButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
// files are wrong, let the user try it again
// sets a flag, nothing else
Function DoTryAgainFewerButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function SkipTransButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function GuessAllTransFiles(variable numChars)
...
Function fGuessSelectedTransFiles(variable numChars)
...
Function ClearSelectedAssignments(string ctrlName)
