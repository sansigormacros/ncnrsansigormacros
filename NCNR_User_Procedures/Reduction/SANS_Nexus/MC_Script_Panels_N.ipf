...
Function RL_ABSCheck(string name, variable value)
...
Function RL_NoiseCheck(string name, variable value)
...
//
Function Sim_StoreConfigButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_RecallConfigPopMenu(STRUCT WMPopupAction &pa) : PopupMenuControl
...
//
//
Function Sim_StoreSampleButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_RecallSamplePopMenu(STRUCT WMPopupAction &pa) : PopupMenuControl
...
//
Function RunListTabProc(string name, variable tab)
...
//
Function Sim_AddToRunListButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
//
Function Sim_AddTransToRunListButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
//
Function Sim_AddEmptyToRunListButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_ClearRowRunListButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_SaveRunListButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_RestoreRunListButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_SaveSampleButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
//
Function Sim_RestoreSampleButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_SaveConfigButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_RestoreConfigButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_ClearConfigButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_ClearSampleButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_RunSelected1DButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_RunSelectedDryButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
//
Function Sim_RunSelected2DButton(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function Sim_RunSelected2DList(STRUCT WMButtonAction &ba)
