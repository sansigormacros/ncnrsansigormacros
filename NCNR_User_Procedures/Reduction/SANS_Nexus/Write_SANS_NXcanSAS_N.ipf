...
// type = data location, in memory, relative to root:Packages:NIST:
// fullPath = file path and name where data will be saved
// if dialog = 1, prompt user for file path, otherwise, use fullpath
Function WriteNxCanSAS1D(string type, string fullpath, variable dialog)
...
// type // data location, in memory, relative to root:Packages:NIST:
// fullPath // file path and name where data will be saved
// dialog // if 1, prompt user for file path, otherwise, use fullpath

Function WriteNxCanSAS2D(string type, string fullpath, variable dialog)
...
Function WriteMetaData(variable fileID, string base, string parentBase, string type)
...
Function WriteProcess(variable fileID, string parentBase, string base, string processName, string processNote)
...
Function WriteNSORTedNXcanSASFile(WAVE qw, WAVE iw, WAVE sw, string firstFileName, string secondFileName, string thirdFileName, string fourthFileName, string normTo, variable norm12, variable norm23, variable norm34, [WAVE res])
...
Function/S CreateNSORTProcess(string firstFileName, string secondFileName, string thirdFileName, string fourthFileName, string normTo, variable norm12, variable norm23, variable norm34)
