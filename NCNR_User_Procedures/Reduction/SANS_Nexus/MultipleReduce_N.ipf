...
//
Function/S FullNameListFromFileList(string list)
...
//
Function DoReduceList(string list)
...
//
Function FileNumberListProc(string ctrlName, variable varNum, string varStr, string varName) : SetVariableControl
...
//
Function PickMRPathButton(string PathButton) : ButtonControl
...
//
Function MREDPopMenuProc(string MRFilesPopup, variable popNum, string popStr) : PopupMenuControl
...
//
Function MRProtoPopMenuProc(string MRProto_pop, variable popNum, string popStr) : PopupMenuControl
...
//
Function MRDoneButtonProc(string ctrlName) : ButtonControl
...
//
Function ReduceAllPopupFiles(string ctrlName) : ButtonControl
...
//*****unused*******
Function/S PossiblyQuoteFileList(string list, string separator)
...
Function ScatteringAtSDDTableButton(string ctrlName)

	Execute "CreateScatteringAtSDDTable()"
	return (0)
End

Function AcceptMREDList(string ctrlName)
...
//
Function RemoveLabeledFromSDDList(string findThisStr)
...
// need fuzzy comparison, since SDD = 1.33 may actually be represented in FP as 1.33000004	!!!
//
Function RemoveWrongSDDFromSDDList(variable tSDD)
...
Function GetHeaderInfoToSDDWave(string fname, string sname)
