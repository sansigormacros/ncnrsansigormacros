...
//
//
Function DeadTimeCorrectionTubes(WAVE dataW, WAVE data_errW, WAVE dtW, variable ctTime)
...
//
//
Function DeadTimeCorrectionOrdela(WAVE dataW, WAVE data_errW, variable deadtime, variable ctTime)
...
Function NonLinearCorrection(string fname, WAVE dataW, WAVE coefW, variable tube_width, string destPath)
...
//
threadsafe Function Convert_xLoc_pix2mm(variable pix, variable tube_width)
...
//
//
threadsafe Function Convert_yLoc_pix2mm(variable xPix, variable yPix, WAVE cw)
...
//
//
Function ConvertBeamCtrPix_to_mm(string folder, string destPath)
...
// the value in pixels is written to the local data folder, NOT to disk (it is recalculated as needed)
//
Function ConvertBeamCtr_to_pixB(string folder, string destPath)
...
//	Wave data_realDistY = $(destPath + ":entry:instrument:detector:data_realDistY")
//
Function Detector_CalcQVals(string fname, string destPath)
...
//
threadsafe Function T_CalcQval_old(variable xaxval, variable yaxval, variable xctr, variable yctr, variable sdd, variable lam, WAVE distX, WAVE distY)
...
//returned magnitude of Q is in 1/Angstroms
//
threadsafe Function T_CalcQval(variable xaxval, variable yaxval, variable xctr, variable yctr, variable tube_width, variable sdd, variable lam, WAVE coefW)
...
//
threadsafe Function T_CalcQX(variable xaxval, variable yaxval, variable xctr, variable yctr, variable tube_width, variable sdd, variable lam, WAVE coefW)
...
// this properly accounts for qz
//
threadsafe Function T_CalcQY(variable xaxval, variable yaxval, variable xctr, variable yctr, variable tube_width, variable sdd, variable lam, WAVE coefW)
...
//
threadsafe Function T_CalcQZ(variable xaxval, variable yaxval, variable xctr, variable yctr, variable tube_width, variable sdd, variable lam, WAVE coefW)
...
// this properly accounts for qz
//
threadsafe Function T_CalcQX_old(variable xaxval, variable yaxval, variable xctr, variable yctr, variable sdd, variable lam, WAVE distX, WAVE distY)
...
// this properly accounts for qz
//
threadsafe Function T_CalcQY_old(variable xaxval, variable yaxval, variable xctr, variable yctr, variable sdd, variable lam, WAVE distX, WAVE distY)
...
// this properly accounts for qz, because it is qz
//
threadsafe Function T_CalcQZ_old(variable xaxval, variable yaxval, variable xctr, variable yctr, variable sdd, variable lam, WAVE distX, WAVE distY)
...
threadsafe Function T_FindPhi(variable vx, variable vy)
...
//
//
Function SolidAngleCorrection(WAVE w, WAVE w_err, string fname, string destPath)
...
//
//
Function SolidAngleCorrection_COS3(WAVE w, WAVE w_err, string fname, string destPath)
...
//
//
Function OrdelaEfficiencyCorr(WAVE w, WAVE w_err, string fname, string destPath)
...
//
Function LargeAngleTransmissionCorr(WAVE w, WAVE w_err, string fname, string destPath)
...
//
Function DIVCorrection(WAVE data, WAVE data_err, string workType)
...
//
Function TubeEfficiencyShadowCorr(WAVE w, WAVE w_err, string fname, string destPath)
...
Function Efficiency_Integral(WAVE pWave, variable in_u)
...
//
Function TubeShadowEfficTableOneLam(variable lambda)
...
//
//
Function WindowTransmission(variable tw)
...
//
//
Function DownstreamWindowTransmission(WAVE w, WAVE w_err, string fname, string destPath)
