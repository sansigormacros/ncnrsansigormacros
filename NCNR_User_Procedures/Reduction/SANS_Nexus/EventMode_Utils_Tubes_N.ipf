...
//
Function PickEVRPathButton(PathButton) : ButtonControl
	String PathButton
...
//
Function EVR_LoadAndSTO(PathButton) : ButtonControl
	String PathButton
...
//
Function ChangeSliceViewSetVar(ctrlName,varNum,varStr,varName) : SetVariableControl
	String ctrlName
	Variable varNum
	String varStr
	String varName
...
//
Function EVR_TimeBins(PathButton) : ButtonControl
	String PathButton
...
//
//
Function EVR_RedPopMenuProc(ERFilesPopup,popNum,popStr) : PopupMenuControl
	String ERFilesPopup
	Variable popNum
	String popStr
...
//
Function EVR_ProtoPopMenuProc(ERProto_pop,popNum,popStr) : PopupMenuControl
	String ERProto_pop
	Variable popNum
	String popStr
...
//
Function EVR_DoneButtonProc(ctrlName) : ButtonControl
	String ctrlName
...
//
//
Function EVR_ReduceTopSlice(ctrlName) : ButtonControl
	String ctrlName
...
// reduce all slices
//
Function EVR_ReduceAllSlices(ctrlName) : ButtonControl
	String ctrlName
...
Function ExecuteProtocol_Event(protStr,samStr,sliceNum,skipLoad)
...
Function Dispatch_to_Correct(bgdStr,empStr,drkStr)
...
Function Proto_ABS_Scale(absStr,activeType)
...
Function Absolute_Scale_P(type,absStr)
	String type,absStr
...
Function Proto_ReadMask(maskStr)
	String maskStr
...
Function Proto_doAverage(avgStr,av_type,activeType)
...
//
Function Proto_doPlot(plotStr,av_type,activeType)
...
Function Proto_SaveFile(avgStr,activeType,samFileLoaded,av_type)
