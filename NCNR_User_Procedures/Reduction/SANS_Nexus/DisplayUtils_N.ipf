...
#pragma rtGlobals=3 // Use modern global access method.d.
#pragma version=5.0
...
Function ScaleColorsToData(variable zmin, variable zmax, WAVE colorWave)
...
//
Function fChangeDisplay(string type)
...
Function Fix_LogLinButtonState(variable state)
