...
// updates the graph
//
Function PlotSelectedEMPButtonProc(string ctrlName) : ButtonControl
...
// updates the graph
//
Function PlotSelectedSAMButtonProc(string ctrlName) : ButtonControl
...
//
Function DoAngleSort(string type)
...
//
Function Convert2Countrate(string type, variable doNorm)
...
//
Function NewDataWaves(string fromType, string toType)
...
//
Function AppendDataWaves(string fromType, string toType)
...
//
Function PickBT5PathButton(string PathButton) : ButtonControl
...
//
Function PickSaveButtonProc(string ctrlName) : ButtonControl
...
Function USANSHelpButtonProc(string ctrlName) : ButtonControl
...
//
Function PlotRawButtonProc(string ctrlName) : ButtonControl
...
//
Function FileListBoxProc(string ctrlName, variable row, variable col, variable event)
...
//
Function StatusButtonProc(string ctrlName)
...
//
Function toSamListButtonProc(string ctrlName) : ButtonControl
...
// makes sure that any null items are removed from the wave attached to the listbox
//
Function toEmptyListButtonProc(string ctrlName) : ButtonControl
...
//
Function DelSamButtonProc(string ctrlName) : ButtonControl
...
// the cor_graph is not updated
//
Function DelEmpButtonProc(string ctrlName) : ButtonControl
...
//
Function RefreshListButtonProc(string ctrlName) : ButtonControl
...
//
Function ClearButtonProc(string ctrlName) : ButtonControl
...
//
Function ReadBT5Header(string fname)
...
Function ConcatenateData(string w1, string w2)
...
Function DoCorrectData()
	...
	variable ii, scale, tempI, temperr, maxq, wq
	variable num = numpnts(iqSAM)
...
//
Function CleanOutFolder(string type)
...
//
Function CleanOutGraph(string type)
...
Function RefreshCurrentButtonProc(string ctrlName) : ButtonControl
...
Function CurtoSamListButtonProc(string ctrlName) : ButtonControl
...
Function CurtoEmptyListButtonProc(string ctrlName) : ButtonControl
...
Function UseCurrentDataProc(string ctrlName, variable checked) : CheckBoxControl
...
Function/S getCurrentPath(string inPath)
