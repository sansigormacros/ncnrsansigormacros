...
Function LoadBT5File(string fname, string type)

	SVAR USANSFolder = root:Packages:NIST:USANS:Globals:gUSANSFolder

	variable refnum, timeCol
	variable num = 500
	variable err = 0
...
//
//
Function FindZeroAngle(string type)
...
//
Function ConvertAngle2Qvals(string type, variable pkAngle)
...
//
Function FindTWideCts(string type)
...
Function BT5DateTime2Secs(string datestring)
...
Function BT5Date2Secs(string datestring)
