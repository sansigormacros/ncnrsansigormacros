...
// all are setvarNa
Function/S CtrlNumber(string str)
...
// val = 2 = disable
// val = 0 = edit enabled
Function ThetaEditMode(variable val)
...
Function EnterModeCheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
Function ShowEMPCheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
//
Function U_SimPlotButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function UDoAngleSort(string type)
...
//
Function U_SphereForm(variable scale, variable radius, variable delrho, variable bkg, variable x)
...
Function U_Power_Law_Model(variable A, variable m, variable bgd, variable x) : FitFunc
...
//
Function LoadSimulatedAngleRange(variable set, string type)
...
Function TransformAngleAxisHook(STRUCT WMAxisHookStruct &s)
...
Function FakeUSANSDataFolder(WAVE qval, WAVE aveint, variable dqv, string dataFolder)
...
Function Sim_USANS_ModelPopMenuProc(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function UCALC_SampleAperturePopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
Function UCALC_PresetPopup(STRUCT WMPopupAction &pa) : PopupMenuControl
...
//
Function U_SaveButtonProc(STRUCT WMButtonAction &ba) : ButtonControl
...
Function SaveFakeCOR(string nameStr)
...
//
Function SaveFakeUSANS(string nameStr, variable num, variable set)
...
//
Function U_ConfigTextProc(STRUCT WMButtonAction &ba) : ButtonControl
...
//
Function U_SavePanelProc(STRUCT WMButtonAction &ba) : ButtonControl
