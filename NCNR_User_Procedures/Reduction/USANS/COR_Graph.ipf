...
//
Function SaveButtonProc(string ctrlName) : ButtonControl
...
Function UseCrsrCheckProc(string ctrlName, variable checked) : CheckBoxControl
...
Function TypeToggleCheckProc(string ctrlName, variable checked) : CheckBoxControl
...
//
Function UpdateButtonProc(string ctrlName) : ButtonControl
	...
	string samNote = note(samCts)
	string empNote = note(empCts)
...
//
Function CorrectButtonProc(string ctrlName) : ButtonControl
...
//
Function QpkButtonProc(string ctrlName) : ButtonControl

	variable newPkAngle = 0
	string   dataSet    = "SAM;EMP;"
	string   type       = ""
...
Function LogLinToggleCheckProc(STRUCT WMCheckboxAction &cba) : CheckBoxControl
...
Function QpkFromNote(string type)
...
//
Function RePlotWithUserAngle(string type, variable zeroAngle)
