...
Proc PlotSquareWellStruct(num,qmin,qmax)
	...
	Variable/G root:g_sws
	g_sws := SquareWellStruct(coef_sws,ywave_sws,xwave_sws)
...
//AAO version
Function SquareWellStruct(cw,yw,xw) : FitFunc
	Wave cw,yw,xw
	
#if exists("SquareWellStructX")
	yw = SquareWellStructX(cw,xw)
#else
	yw = fSquareWellStruct(cw,xw)
#endif
	return(0)
End
///////////////////////////////////////////////////////////
...
///////////////////////////
Function fSquareWellStruct(w,x) : FitFunc
	Wave w
	Variable x
