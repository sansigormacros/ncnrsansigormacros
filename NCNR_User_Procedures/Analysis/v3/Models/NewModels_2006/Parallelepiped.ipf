...
Proc Plot_Parallelepiped(num,qmin,qmax)
	...
	make/o/t parameters_Parallelepiped = {"Scale Factor","Shortest Edge A (A)","B (A)","Longest Edge C (A)","Contrast (A^-2)","Incoherent Bgd (cm-1)"}	//CH#3
...
Proc PlotSmeared_Parallelepiped()								//Parallelepiped
	...
	make/o/t smear_parameters_Parallelepiped = {"Scale Factor","Shortest Edge A (A)","B (A)","Longest Edge C (A)","Contrast (A^-2)","Incoherent Bgd (cm-1)"}
