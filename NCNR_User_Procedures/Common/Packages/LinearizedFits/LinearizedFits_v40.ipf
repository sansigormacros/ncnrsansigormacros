...
Window A_FitPanel()
	...
	PopupMenu ywave,mode=1,value=root:Packages:NIST:FIT:gDataPopList,proc=A_FIT_FilePopMenuProc
...
Proc A_FIT_Load_Proc(ctrlName): ButtonControl
	...
	A_LoadOneDDataWithName(tempName,0)		//let A_Rescale_Data() do the plotting
	//Print S_fileName
	//Print tempName
...
Function A_Rescale_Data(dataStr)
	String dataStr
...
Function A_DispatchModel(GoFit) : ButtonControl
	...
	A_Rescale_Data("root:"+partialName+":")
...
Function A_AdjustAxisToCursors()
	...
	String csrA = CsrInfo(A ,"A_FitWindow")
	String csrB = CsrInfo(B ,"A_FitWindow")
