...
Proc Make_Invariant_Panel()
	...
	if(V_flag==0)
		//create global variables in root:invariant
		Init_Invariant()
		Invariant_Panel()
	endif
	//pop the file menu
...
//create the globals
Proc Init_Invariant()
	NewDataFolder/O/S root:invariant
	...
	NewDataFolder/O root:myGlobals		//just in case...
...
Function Plot_Inv_Data(ctrlName) : ButtonControl
	...
	SVAR QWave = root:invariant:QWave
	SVAR IWave = root:invariant:IWave
	SVAR SWave = root:invariant:SWave
...
//	Print TraceNameList("",";",1)
	...
	NVAR meas = root:invariant:gInvMeas
	NVAR lo = root:invariant:gInvLowQ
	NVAR hi = root:invariant:gInvHighQ
	NVAR total = root:invariant:gInvTotal
	meas=0
	lo=0
	hi=0
	total=0
...
Proc Invariant_Panel()
	...
	PopupMenu ywave,mode=1,value=root:invariant:gDataPopList,proc=Inv_FilePopMenuProc
...
//	PopupMenu wavePop_0,pos={15,9},size={139,20},title="q-values"
//	PopupMenu wavePop_0,mode=1,value= #"WaveList(\"*_q\",\";\",\"\")"
//	PopupMenu wavePop_1,pos={15,38},size={140,20},title="Intensity"
//	PopupMenu wavePop_1,mode=1,value= #"WaveList(\"*_i\",\";\",\"\")"
//	PopupMenu wavePop_2,pos={15,65},size={124,20},title="error"
//	PopupMenu wavePop_2,mode=1,value= #"WaveList(\"*_s\",\";\",\"\")"
	SetVariable setvar_0,pos={27,249},size={80,15},title="# points"
	SetVariable setvar_0,limits={5,50,0},value= root:invariant:gNumLow
	SetVariable setvar_1,pos={166,249},size={80,15},title="# points"
	SetVariable setvar_1,limits={5,200,0},value= root:invariant:gNumHigh
...
//	Button button_3,pos={13,98},size={50,20},proc=Plot_Inv_Data,title="Plot"
	...
	ValDisplay valdisp0,value= #"root:invariant:gInvMeas"
	...
	ValDisplay valdisp0_1,value= #"root:invariant:gInvLowQ"
	...
	ValDisplay valdisp0_2,value= #"root:invariant:gInvHighQ"
	ValDisplay valdisp0_3,pos={51,411},size={180,14},title="TOTAL "
	ValDisplay valdisp0_3,limits={0,0,0},barmisc={0,1000}
	ValDisplay valdisp0_3,value= #"root:invariant:gInvTotal"
	
	CheckBox check0,pos={10,116},size={101,14},proc=SlitSmearedCheckProc,title="Slit-Smeared Data"
	CheckBox check0,value= root:invariant:gIsSlitSmeared
	SetVariable setvar0,pos={136,116},size={130,15},title="Slit Height (1/A)"
	SetVariable setvar0,limits={-inf,inf,0},value= root:invariant:gDqv
	
	//set up a dependency to calculate the total invariant
	root:invariant:gInvTotal := root:invariant:gInvLowQ + root:invariant:gInvMeas + root:invariant:gInvHighQ
EndMacro
...
Function InvMeasQ(ctrlName) : ButtonControl
	...
	NVAR isSlitSmeared=root:invariant:gIsSlitSmeared
	if(isSlitSmeared)
...
//	print "yesGuinier = ",yesGuinier
	...
	NVAR nbeg=root:invariant:gNumLow
	//define the waves
	Wave extr_lqi=extr_lqi
	Wave extr_lqq=extr_lqq
...
Function InvHighQ(ctrlName) : ButtonControl
	...
	NVAR nend=root:invariant:gNumHigh		//number of points for the fit
...
Function UnloadInvariant()
	...
	if (DatafolderExists("root:invariant"))
		KillDatafolder root:invariant
	endif
	Execute/P "DELETEINCLUDE \"Invariant\""
...
Function Inv_HelpButtonProc(ctrlName) : ButtonControl
	...
	DisplayHelpTopic "Calculate Scattering Invariant"
End
...
Function Inv_FilePopMenuProc(ctrlName,popNum,popStr) : PopupMenuControl
	...
	Endif
	String/G root:invariant:gDataPopList =tempStr
...
Proc Inv_Load_Proc(ctrlName): ButtonControl
	...
	String/G root:invariant:QWave=tempName
	tempName=cleanLastFileName+"_i"
	String/G root:invariant:IWave=tempName
	tempName=cleanLastFileName+"_s"
	String/G root:invariant:SWave=tempName
...
Function SlitSmearedCheckProc(ctrlName,checked) : CheckBoxControl
	...
	NVAR isSlitSmeared=root:invariant:gIsSlitSmeared
	SVAR fileStr=root:myGlobals:gLastFileName
