...
//	print gCASE
	...
	Duplicate/O $gQvals smeared_rpa,smeared_qvals	
	SetScale d,0,0,"1/cm",smeared_rpa	

	smeared_rpa := SmearedRPAForm(smear_coefvalues_rpa,$gQvals)
...
Function SmearedRPAForm(w,x) :FitFunc
	Wave w
	Variable x
	...
	ans = Smear_Model_20(RPAForm,$sq,$qb,$sh,$gQ,w,x)
