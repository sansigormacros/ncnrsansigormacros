...
Proc PlotSmearedEllipsoidForm()	
	...
	Duplicate/O $gQvals smeared_eor,smeared_qvals
	SetScale d,0,0,"1/cm",smeared_eor	

	smeared_eor := SmearedEllipsoidForm(smear_coef_eor,$gQvals)
...
///////////////////////////
Function EllipsoidForm(w,x) : FitFunc
	Wave w
	Variable x
...
Function SmearedEllipsoidForm(w,x) :FitFunc
	Wave w
	Variable x
	...
	ans = Smear_Model_20(EllipsoidForm,$sq,$qb,$sh,$gQ,w,x)
