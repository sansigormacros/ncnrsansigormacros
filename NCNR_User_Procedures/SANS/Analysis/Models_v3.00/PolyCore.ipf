...
Proc PlotSmearedPolyCoreForm()						
	...
	Duplicate/O $gQvals smeared_pcf,smeared_qvals
...
///////////////////////////
Function PolyCoreForm(w,h) : FitFunc
	Wave w
...
Function SmearedPolyCoreForm(w,x) :FitFunc
	Wave w
	Variable x
	...
	ans = Smear_Model_20(PolyCoreForm,$sq,$qb,$sh,$gQ,w,x)
