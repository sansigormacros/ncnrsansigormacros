...
//	Variable/G root:gMaxIter=20
	...
	make/o/t parameters_ecf = {"scale","minor radius (A)","nu = major/minor (-)","length (Å)","SLD cylinder (A^-2)","SLD solvent (A^-2)","incoh. bkg (cm^-1)"}
...
Proc PlotSmearedEllipticalCylinder(str)								
	...
	make/o/t smear_parameters_ecf = {"scale","minor radius (A)","nu = major/minor (-)","length (Å)","SLD cylinder (A^-2)","SLD solvent (A^-2)","incoh. bkg (cm^-1)"}
