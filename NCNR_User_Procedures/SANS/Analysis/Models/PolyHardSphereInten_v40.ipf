...
Proc PlotSmearedPolyHardSpheres(str)								
	String str
	...
	Duplicate/O $(str+"_q") smeared_phs,smeared_qvals
	SetScale d,0,0,"1/cm",smeared_phs					
		
	Variable/G gs_phs=0
	gs_phs := fSmearedPolyHardSpheres(smear_coef_phs,smeared_phs,smeared_qvals)	//this wrapper fills the STRUCT
...
Function SmearedPolyHardSpheres(s) :FitFunc
...
//
Function fSmearedPolyHardSpheres(coefW,yW,xW)
	Wave coefW,yW,xW
